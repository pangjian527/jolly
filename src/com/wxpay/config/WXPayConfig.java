...
public class WXPayConfig {
	...
	//本机测试
	public static final String NOTIFY_URL = "http://wersty.oicp.net/jolly/wx_notify_url.html";
	...
	public static final String PUBLIC_MCH_ID = "1442720602";// ，公众平台商户
	public static final String PUBLIC_APPSECRET = "c0ce8689442ddf64541dacff25e99934";//公众号密钥
	
	public static final String PUBLIC_API_KEY="JOLLY8179FLYING1400zljinfei020DZ";//支付密钥
	// 字符编码格式 目前支持  utf-8
