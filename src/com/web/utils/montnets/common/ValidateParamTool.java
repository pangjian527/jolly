...
public class ValidateParamTool
{
	 ...
	 * @return
	 */
	public static boolean validateMessageNew(String strMessage){
		try
		{
			if(strMessage != null  && !"".equals(strMessage) && strMessage.length()<=990){
				return true;
			}else{
				return false;
			}
	 ...
	 * @return
	 */
	public static boolean validateMobilesNew(String strMobiles){
		try{
			 if(strMobiles != null && !"".equals(strMobiles))
        	 {
        	     String[] arrMobiles = strMobiles.split(","); 
