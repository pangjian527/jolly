...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   </ul>",
                this.opts.html?this.opts.html:"",//2014-4-18 pj add 用于在select后面加上自定义HTML。比如说追加一个按钮
                "</div>"].join(""));
            return container;
        },
    ...
    $.fn.select2.defaults = {
        ...
        id: function (e) { return e.id||e.ID; },//add pj 2013-07-18 有些json经过后台格式化后，属性变成了大写，导致无法识别 
