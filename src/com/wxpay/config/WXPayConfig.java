...
public class WXPayConfig {
	...
	//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	public static final String PUBLIC_APP_ID = "wx59037755f6e7c0d3";// 移动应用，公众平台移动应用
	public static final String PUBLIC_MCH_ID = "1238565702";// ，公众平台商户
	public static final String PUBLIC_APPSECRET = "d14076baabed939e413821db10943d6c";//公众号密钥
