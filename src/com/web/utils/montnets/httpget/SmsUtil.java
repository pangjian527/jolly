...
public class SmsUtil {
	...
	public String[] MongateGetDeliverForGet(Params params, boolean bKeepAlive, Object connection){
		String[] Result = null;
	...
	public Integer MongateQueryBalanceForGet(Params params, boolean bKeepAlive,Object connection){
		Integer result = null;
		try {
			  String Message=null;
			  if(!bKeepAlive){
	...
	public String MongateSendSubmitForGet(Params params, boolean bKeepAlive,Object connection) {
		String result =null;
		try {
			 String Message=null;
			 if(!bKeepAlive){
	 ...
	 * @return返回值：
		...
		-999	web服务器内部错误
	 */
	public String MongateCsSpSendSmsNewForGet(ParamsNew params) {
		String result =null;
		try {
			 String Message=null;
				 Message = executeGet(params, host+url+"MongateCsSpSendSmsNew");
	...
	public String MongateMULTIXSendForGet(Params params,  boolean bKeepAlive, Object connection) throws Exception
	{
		String result =null;
		try {
			String Message=null;
	 ...
	 * @throws Exception
	 */
	private String executeGet(Object obj, String httpUrl,HttpClient httpclient) throws Exception {
